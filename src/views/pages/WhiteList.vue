<template>
  <div class="animated fadeIn">
    ...
    <div class = "text-left">
      ...
      <b-table responsive="sm" :items="dataUser" :fields="fields2">
...
import {getToken, getUserDataInSession2} from '../../utils';
export default {
  data: () => ({
    dataUser: [],
    totalUser: '',
  ...
  methods: {
    ...
    getData() {
      ...
      console.log("ROLE : " + getUserDataInSession2("userRole"))
      console.log("COMPANY ID : " + getUserDataInSession2("userCompanyId"))
      console.log("COMPANY Name : " + getUserDataInSession2("userCompanyName"))
      ...
      console.log(headers)
      axios.get("https://antares.pede.id/sg-web-service/v1/employees?page=1&size=5&company-id=1",{
            headers
            },
          // }
        ).then(response => {
